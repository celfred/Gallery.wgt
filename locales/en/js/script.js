...
function start(){
    ...
    $('#index_checkbox').click( function() {
      if ( $(this).is(':checked') ) {
        ...
        // Hide index
        //$("#slider").easySlider({ numeric: false });
      }
    })
    ...
    $(document).on("click", ".size_up", function(){
        $(this).parent().height("");
    ...
    $(document).on("click", ".size_down", function(){    
        var fz = parseInt($(this).parent().css("font-size").replace("px", ""));
        fz = ((fz - 1) < 8)?8:fz-1;
    ...
    //play/pause event
    $(document).on("click", ".play, .stop", function(){
        var tmp_audio = $(this);
    ...
    //moving objects
    $(document).on("mouseover", ".move_block", function(){
        $(this).parent().draggable();
    });

    $(document).on("mouseleave", ".move_block", function(){
        if(!mouse_state)
            $(this).parent().draggable("destroy");
    });
    
    $(document).on("mousedown", ".move_block", function(){
        mouse_state = true;
    });
    
    $(document).on("mouseup",".move_block", function(){
        mouse_state = false;
    });
    
    //resize block
    $(document).on("mousedown", ".resize_block", function(event){
    ...
    $(document).on("mouseup", "li>div", function(){
    ...
    $(document).on("mousemove", "li>div", function(event){
    ...
    $(document).on("click", ".close_slide", function(){
        ...
        $("#slider ul").cycle('remove', O); // TODO : Find slide index (from pager active class?)
        alert($('.cycle-slideshow').data("cycle.opts").currSlide);
        //$("#slider").removeSlide();
        //$("#slider").easySlider();
    });
...
function showExample() {
    ...
    $("<div class='text_block'><div class='real_text'>" + sankoreLang.text_content + "</div></div>").appendTo(div1).draggable();
    ...
    var img = $("<div class='img_block' style='text-align: center;'></div>").appendTo(div2).draggable();
    ...
    $("<div class='text_block'><div class='real_text'>" + sankoreLang.text_content + "</div></div>").appendTo(div4).draggable();
